...
Before finalizing edits, review your changes for duplicated logic, complexity, or architectural concerns. Document findings in `docs/templates/static-analysis-report.md` and include key observations in your Codex prompt along with the helper findings.
